...
<script type="text/javascript" src="/js/myJs/excData.js"></script>
...
<body>
	...
	<div class="box">
		...
		<div class="excForm">
			...
			<div class="bottom">
			<a href="javascript:accede()"><button class="btn btn-default">同意交换</button></a>
			<a href="javascript:refuse()"><button class="btn btn-default">拒绝交换</button></a>
