...
<script type="text/javascript" src="/js/myJs/pending.js"></script>
<style type="text/css">
...
<jsp:include page="../head.jsp"></jsp:include>
	<div class="top">
		<div class="tl">
			<h1 style="color: white;">待处理的请求</h1>
		</div>
	...
	<div class="right-data">
		...
		<div class="d-table">
			<div class="dt-param" ><a href="/admin/mySubmitPage" >已提交的</a></div>
			<div class="dt-param" ><a href="/admin/pending" style="color:red;">待处理的</a></div>
